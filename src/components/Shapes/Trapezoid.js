...
function Trapezoid({ data, onColorChange }) {
  ...
  return (
    <div className="trapezoid" style={{ backgroundColor: color, padding: '10px', borderRadius: '5px', boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)' }}>
